...
<div style="max-width: 1100px; margin: 0 auto; padding: 40px 32px;">
    ...
    <div style="display: grid; grid-template-columns: repeat(auto-fit, minmax(280px, 1fr)); gap: 24px; margin-bottom: 48px;">
        ...
        <div class="home-feature-card" style="--card-accent: #4a9b6f;" onclick="App.switchView('resources'); setTimeout(() => ResourceManager.switchWidget('tests'), 10)">
            <div class="card-icon" style="background: rgba(74, 155, 111, 0.1); color: #4a9b6f;">
        ...
        <div class="home-feature-card" style="--card-accent: #d97757;" onclick="App.switchView('resources'); setTimeout(() => ResourceManager.switchWidget('guide'), 10)">
            <div class="card-icon" style="background: rgba(217, 119, 87, 0.1); color: #d97757;">
                <svg viewBox="0 0 24 24" width="24" height="24" fill="none" stroke="currentColor" stroke-width="2" aria-hidden="true">
        ...
        <div class="home-feature-card" style="--card-accent: #4a9b6f;" onclick="App.switchView('resources'); setTimeout(() => ResourceManager.switchWidget('prompts'), 10)">
            <div class="card-icon" style="background: rgba(74, 155, 111, 0.1); color: #4a9b6f;">
                <svg viewBox="0 0 24 24" width="24" height="24" fill="none" stroke="currentColor" stroke-width="2" aria-hidden="true">
